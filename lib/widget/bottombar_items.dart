...
List<Widget> bottomBarItems(BuildContext context, Widget widget) {
  ...
  return [
    ...
    //Profile Button
    OutlinedButton.icon(onPressed: isProfile ? null : () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ProfileScreen())), icon: FaIcon(FontAwesomeIcons.user, color: isProfile ? Colors.white30 : Colors.white), label: Text('Profil', style: TextStyle(color: isProfile ? Colors.white30 : Colors.white))),
  ];
}
